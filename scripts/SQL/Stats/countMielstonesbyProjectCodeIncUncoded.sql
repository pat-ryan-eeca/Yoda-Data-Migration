...
DECLARE @grantStepId INT= 526; 
	...
	with Variation_Milestone as (			
		SELECT
			...
			select active.project_code, active.milestone_code_description, active.count_project_milestones as milestonecount
			from
			...
			RIGHT OUTER JOIN  rvMilestoneCodes  mc on 
